...
public sealed class FutureDependenciesClassData() : TheoryData<IReadOnlyCollection<(
    IReadOnlyCollection<KeyValuePair<NugetDependency, IReadOnlyCollection<PackageVersionWithDependencySets>>> FetchVersion,
    IReadOnlyDictionary<string, PackageVersionWithDependencySets?> FetchMetadata
    )>>(
    [
        (
            FetchVersion:
